...
# Size of source mod 2**32: 21872 bytes
...
Parse error at or near `RETURN_VALUE' instruction at offset 76
    ...
    def create_photo_from_photo_data(cls, camera_mode, camera_quality, photographer_sim_id, target_obj_id, target_sim_ids, res_key, second_res_key, photo_style, photo_size, photo_orientation, photographer_sim_info, photographer_sim, time_stamp, selected_mood_param):
        ...
        elif photo_orientation == PhotoOrientation.LANDSCAPE:
        ...
        if photo_object_def is None:
            ...
            if camera_mode == CameraMode.PUZZLE_BY_REFERENCE:
                ...
                canvas_state = PuzzleState.from_key(res_key, reveal_level=reveal_level,
                  effect=photo_style,
                  overlay_texture_id=(old_state.overlay_texture_id),
                  reveal_texture_id=(old_state.reveal_texture_id),
                  reveal_texture_id_b=(old_state.reveal_texture_id_b))
        else:
            canvas_state = PaintingState.from_key(res_key, reveal_level=reveal_level,
              effect=photo_style)
        ...
        photo_for_reference or cls._apply_quality_and_value_to_photo(photographer_sim, photo_object, photo_style, camera_quality)
