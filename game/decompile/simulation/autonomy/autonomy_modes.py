...
# Size of source mod 2**32: 188752 bytes
...
class AutonomyMode:
    ...
    def _score_motives--- This code section failed: ---

 L. 472         0  LOAD_CONST               None
                2  STORE_FAST               'motive_scores'

 L. 480         4  LOAD_CLOSURE             'self'
                6  BUILD_TUPLE_1         1 
                8  LOAD_DICTCOMP            '<code_object <dictcomp>>'
               10  LOAD_STR                 'AutonomyMode._score_motives.<locals>.<dictcomp>'
               12  MAKE_FUNCTION_8          'closure'

 L. 481        14  LOAD_GLOBAL              tuple
               16  LOAD_DEREF               'self'
               18  LOAD_ATTR                _sim
               20  LOAD_METHOD              scored_stats_gen
               ...
               30  STORE_FAST               'motive_scores'

 L. 482        32  LOAD_DEREF               'self'
               34  LOAD_ATTR                _request
               36  LOAD_ATTR                has_commodities
               38  POP_JUMP_IF_FALSE   108  'to 108'

 L. 483        40  SETUP_LOOP          108  'to 108'
               42  LOAD_DEREF               'self'
               44  LOAD_ATTR                _request
               46  LOAD_ATTR                all_commodities
               48  GET_ITER         
             50_0  COME_FROM            66  '66'
               50  FOR_ITER            106  'to 106'
               52  STORE_FAST               'stat'

 L. 484        54  LOAD_FAST                'stat'
               56  LOAD_ATTR                stat_type
               58  STORE_FAST               'stat_type'

 L. 485        60  LOAD_FAST                'stat_type'
               62  LOAD_FAST                'motive_scores'
               64  COMPARE_OP               not-in
               66  POP_JUMP_IF_FALSE    50  'to 50'

 L. 486        68  LOAD_DEREF               'self'
               70  LOAD_ATTR                _sim
               72  LOAD_ATTR                get_stat_instance
               74  LOAD_FAST                'stat_type'
               76  LOAD_CONST               False
               78  LOAD_CONST               ('add',)
               80  CALL_FUNCTION_KW_2     2  '2 total positional and keyword args'
               82  JUMP_IF_TRUE_OR_POP    86  'to 86'
               84  LOAD_FAST                'stat_type'
             86_0  COME_FROM            82  '82'
               86  STORE_FAST               'statistic_instance'

 L. 487        88  LOAD_GLOBAL              ScoredStatistic
               90  LOAD_FAST                'statistic_instance'
               92  LOAD_DEREF               'self'
               94  LOAD_ATTR                _sim
               96  CALL_FUNCTION_2       2  '2 positional arguments'
               98  LOAD_FAST                'motive_scores'
              100  LOAD_FAST                'stat_type'
              102  STORE_SUBSCR     
              104  JUMP_BACK            50  'to 50'
              106  POP_BLOCK        
            108_0  COME_FROM_LOOP       40  '40'
            108_1  COME_FROM            38  '38'

 L. 488       108  LOAD_FAST                'motive_scores'
              110  RETURN_VALUE     
               -1  RETURN_LAST      
...
class FullAutonomy(_SuperInteractionAutonomy):
    ...
    def _score_object_interactions_gen(self, timeline, obj, timeslice_if_needed_gen, inventory_type, best_threshold):
        ...
        if not is_available:
            ...
            return potential_interactions or (
        ...
        for aop in potential_interactions:
            ...
            if self._gsi_interactions is not None:
                ...
                continue
            if obj.check_affordance_for_suppression((self._sim), aop, False, check_option=(SuppressionCheckOption.PROVIDED_AFFORDANCE_ONLY)) or self._sim.sim_info.check_affordance_for_suppression((self._sim), aop, False, check_option=(SuppressionCheckOption.AFFORDANCE_ONLY)):
                if self._request.record_test_result is not None:
            ...
            if autonomy_constraints is None:
                ...
                if self._request.tuned_constraint_entries:
                ...
                if must_change_posture:
                    if interaction.apply_autonomous_posture_change_cost:
                        if self._sim.si_state.has_visible_si():
                            change_posture_cost = self.POSTURE_CHANGE_OPPORTUNITY_COST_MULTIPLIER
                            total_opportunity_cost *= change_posture_cost
...
class InteractionScore(float):
    ...
    def __init__(self, score, interaction, commodity_scores=None, efficiency=None, duration=None, autonomy_scoring_preference=None, rel_utility_score=None, relationship_object_value=None, party_score=None, opportunity_costs=None, must_change_posture=None, change_posture_cost=1.0, base_multitasking_percentage=None, bonus_multitasking_percentage=None, penalty_multitasking_percentage=None, attention_cost_scores=None, attention_cost_bonus_scores=None, attention_cost_penalty_scores=None, outside_multiplier=None, waiting_in_line_multiplier=None, club_rule_multiplier=None, off_lot_object_score_multiplier=None, ensemble_multiplier=None, buff_utility_score=1.0, situation_type_utility_score=1.0, sit_posture_transition_penalty=1.0, estimated_distance=0, route_time=0, tested_relationship_utility_score=1.0, remaining_sis_score=1.0, interaction_score_modifier_multiplier=1.0, minimum_score=0.0):
        ...
        self.change_posture_cost = change_posture_cost
        ...
        if not self.HAS_SHOWN_GSI_OUT_OF_DATE_ERROR:
        ...
        verify_final_score -= sum(self.opportunity_costs.values()) * self.change_posture_cost
        ...
        if not sims4.math.almost_equal(verify_final_score, score):
            ...
            self.HAS_SHOWN_GSI_OUT_OF_DATE_ERROR = True
    ...
    def __str__(self):
        ...
        change_posture_cost_str = '{} -> {}'.format(self.must_change_posture, self.change_posture_cost)
        total_opportunity_cost = sum(self.opportunity_costs.values()) * self.change_posture_cost
