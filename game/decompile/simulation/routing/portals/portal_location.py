            ...
            if routing_surface == ROUTING_SURFACE_OBJECT:
                ...
                if routing_surface == ROUTING_SURFACE_GLOBAL_OBJECT:
                    ...
                    if routing_surface == ROUTING_SURFACE_OCEAN:
                        ...
                        if routing_surface == ROUTING_SURFACE_PARENT_OBJECT:
