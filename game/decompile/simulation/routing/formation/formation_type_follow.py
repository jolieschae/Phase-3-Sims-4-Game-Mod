...
class FormationTypeFollow(FormationTypeBase):
    ...
    def find_good_location_for_slave(self, master_location):
        ...
        water_depth_info = placement.WaterDepthInfo(max_water_depth=max_water_depth, min_water_depth=min_water_depth,
        ...
        if fgl_tuning.slave_should_face_master:
            ...
            raytest_info = placement.RaytestInfo(raytest_radius=(self.RAYTRACE_RADIUS), raytest_start_offset=(self.RAYTRACE_HEIGHT),
              raytest_end_offset=(self.RAYTRACE_HEIGHT),
              raytest_start_point_override=(master_location.transform.translation))
            fgl_kwargs.update({'raytest_info':raytest_info,  'ignored_object_ids':{
