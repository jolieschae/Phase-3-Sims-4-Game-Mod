...
class DynamicInteractionSpawnPoint(SpawnPoint):
    ...
    def _get_pos(self):
        ...
        if participant is not None:
            ...
            fgl_context = placement.FindGoodLocationContext(starting_location, additional_avoid_sim_radius=(routing.get_default_agent_radius()),
              max_steps=10,
              position_increment_info=pos_increment_info,
              offset_info=(OffsetInfo(self._distance_to_participant)),
              scoring_functions=(
             scoring_function,),
