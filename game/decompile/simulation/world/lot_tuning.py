...
# Size of source mod 2**32: 27698 bytes
...
class ObjectCountTuningOptimizer:
    ...
    def increment_statistics--- This code section failed: ---

 L. 650         0  LOAD_GLOBAL              collections
                2  LOAD_METHOD              defaultdict
                4  LOAD_GLOBAL              TestSetStats
                6  CALL_METHOD_1         1  '1 positional argument'
                8  STORE_FAST               'tests_to_run'

 L. 652        10  LOAD_CLOSURE             'obj'
               12  BUILD_TUPLE_1         1 
               14  LOAD_SETCOMP             '<code_object <setcomp>>'
               16  LOAD_STR                 'ObjectCountTuningOptimizer.increment_statistics.<locals>.<setcomp>'
               18  MAKE_FUNCTION_8          'closure'
               20  LOAD_FAST                'self'
               22  LOAD_ATTR                _relevant_tags
               24  GET_ITER         
               26  CALL_FUNCTION_1       1  '1 positional argument'
               28  STORE_FAST               'tags'

 L. 653        30  LOAD_FAST                'tags'
               32  POP_JUMP_IF_FALSE   106  'to 106'

 L. 654        34  SETUP_LOOP          106  'to 106'
               36  LOAD_FAST                'tags'
               38  GET_ITER         
               40  FOR_ITER            104  'to 104'
               42  STORE_FAST               'tag'

 L. 655        44  LOAD_FAST                'self'
               46  LOAD_ATTR                _tag_to_test_mapping
               48  LOAD_FAST                'tag'
               50  BINARY_SUBSCR    
               52  STORE_FAST               'test_list'

 L. 656        54  SETUP_LOOP          102  'to 102'
               56  LOAD_FAST                'test_list'
               58  GET_ITER         
               60  FOR_ITER            100  'to 100'
               62  UNPACK_SEQUENCE_2     2 
               64  STORE_FAST               'test_set'
               66  STORE_FAST               'statistic'

 L. 657        68  LOAD_FAST                'tests_to_run'
               70  LOAD_GLOBAL              id
               72  LOAD_FAST                'test_set'
               74  CALL_FUNCTION_1       1  '1 positional argument'
               76  BINARY_SUBSCR    
               78  STORE_FAST               'test_set_stats'

 L. 658        80  LOAD_FAST                'test_set'
               82  LOAD_FAST                'test_set_stats'
               84  STORE_ATTR               test_set

 L. 659        86  LOAD_FAST                'test_set_stats'
               88  LOAD_ATTR                stats
               90  LOAD_METHOD              append
               92  LOAD_FAST                'statistic'
            ...
            102_0  COME_FROM_LOOP       54  '54'
              ...
              104  POP_BLOCK        
            106_0  COME_FROM_LOOP       34  '34'
            106_1  COME_FROM            32  '32'

 L. 661       106  LOAD_DEREF               'obj'
              108  LOAD_ATTR                state_component
              110  STORE_FAST               'state_component'

 L. 662       112  LOAD_FAST                'state_component'
              114  LOAD_CONST               None
              116  COMPARE_OP               is-not
              118  POP_JUMP_IF_FALSE   202  'to 202'

 L. 663       120  SETUP_LOOP          202  'to 202'
              122  LOAD_FAST                'self'
              124  LOAD_ATTR                _state_to_test_mapping
              126  LOAD_METHOD              items
              128  CALL_METHOD_0         0  '0 positional arguments'
              130  GET_ITER         
            132_0  COME_FROM           148  '148'
              132  FOR_ITER            200  'to 200'
              134  UNPACK_SEQUENCE_2     2 
              136  STORE_FAST               'state'
              138  STORE_FAST               'test_list'

 L. 664       140  LOAD_FAST                'state_component'
              142  LOAD_METHOD              has_state
              144  LOAD_FAST                'state'
              146  CALL_METHOD_1         1  '1 positional argument'
              148  POP_JUMP_IF_FALSE   132  'to 132'

 L. 665       150  SETUP_LOOP          198  'to 198'
              152  LOAD_FAST                'test_list'
              154  GET_ITER         
              156  FOR_ITER            196  'to 196'
              158  UNPACK_SEQUENCE_2     2 
              160  STORE_FAST               'test_set'
              162  STORE_FAST               'statistic'

 L. 666       164  LOAD_FAST                'tests_to_run'
              166  LOAD_GLOBAL              id
              168  LOAD_FAST                'test_set'
              170  CALL_FUNCTION_1       1  '1 positional argument'
              172  BINARY_SUBSCR    
              174  STORE_FAST               'test_set_stats'

 L. 667       176  LOAD_FAST                'test_set'
              178  LOAD_FAST                'test_set_stats'
              180  STORE_ATTR               test_set

 L. 668       182  LOAD_FAST                'test_set_stats'
              184  LOAD_ATTR                stats
              186  LOAD_METHOD              append
              188  LOAD_FAST                'statistic'
              190  CALL_METHOD_1         1  '1 positional argument'
              192  POP_TOP          
              194  JUMP_BACK           156  'to 156'
              196  POP_BLOCK        
            198_0  COME_FROM_LOOP      150  '150'
              198  JUMP_BACK           132  'to 132'
              200  POP_BLOCK        
            202_0  COME_FROM_LOOP      120  '120'
            202_1  COME_FROM           118  '118'

 L. 670       202  LOAD_FAST                'tests_to_run'
              204  POP_JUMP_IF_TRUE    210  'to 210'

 L. 671       206  LOAD_CONST               None
              208  RETURN_VALUE     
            210_0  COME_FROM           204  '204'

 L. 673       210  LOAD_GLOBAL              SingleObjectResolver
              212  LOAD_DEREF               'obj'
              214  CALL_FUNCTION_1       1  '1 positional argument'
              216  STORE_FAST               'resolver'

 L. 674       218  LOAD_GLOBAL              set
              220  CALL_FUNCTION_0       0  '0 positional arguments'
              222  STORE_FAST               'incremented_statistics'

 L. 675       224  SETUP_LOOP          308  'to 308'
              226  LOAD_FAST                'tests_to_run'
              228  LOAD_METHOD              values
              230  CALL_METHOD_0         0  '0 positional arguments'
              232  GET_ITER         
            234_0  COME_FROM           248  '248'
              234  FOR_ITER            306  'to 306'
              236  STORE_FAST               'test_set_stats'

 L. 676       238  LOAD_FAST                'test_set_stats'
              240  LOAD_ATTR                test_set
              242  LOAD_METHOD              run_tests
              244  LOAD_FAST                'resolver'
              246  CALL_METHOD_1         1  '1 positional argument'
              248  POP_JUMP_IF_FALSE   234  'to 234'

 L. 677       250  SETUP_LOOP          304  'to 304'
              252  LOAD_FAST                'test_set_stats'
              254  LOAD_ATTR                stats
              256  GET_ITER         
            258_0  COME_FROM           268  '268'
              258  FOR_ITER            302  'to 302'
              260  STORE_FAST               'statistic'

 L. 678       262  LOAD_FAST                'statistic'
              264  LOAD_FAST                'incremented_statistics'
              266  COMPARE_OP               not-in
          268_270  POP_JUMP_IF_FALSE   258  'to 258'

 L. 679       272  LOAD_FAST                'statistic_values'
              274  LOAD_FAST                'statistic'
              276  DUP_TOP_TWO      
              278  BINARY_SUBSCR    
              280  LOAD_CONST               1
              282  INPLACE_ADD      
 ...
 L. 680       288  LOAD_FAST                'incremented_statistics'
              290  LOAD_METHOD              add
              292  LOAD_FAST                'statistic'
              294  CALL_METHOD_1         1  '1 positional argument'
              296  POP_TOP          
          298_300  JUMP_BACK           258  'to 258'
              302  POP_BLOCK        
            304_0  COME_FROM_LOOP      250  '250'
              304  JUMP_BACK           234  'to 234'
              306  POP_BLOCK        
            308_0  COME_FROM_LOOP      224  '224'

Parse error at or near `LOAD_SETCOMP' instruction at offset 14
