...
# Size of source mod 2**32: 42991 bytes
...
from carry.carry_elements import ExitCarryWhileHolding, EnterCarryWhileHolding, TransferCarryWhileHolding, ChangeCarryWhileHolding
...
from sims.aging.aging_element import ChangeAgeElement, AgeUpMomentElement
...
from travel_group.travel_group_elements import TravelGroupAdd, TravelGroupRemove, TravelGroupExtend, TravelGroupEnd, TravelGroupClaimObject
...
class BasicExtraVariantCore(TunableVariant):
    ...
    def __init__(self, **kwargs):
        (super().__init__)(add_to_ensemble=AddToEnsemble.TunableFactory(), 
         ...
         age_moment=AgeUpMomentElement.TunableFactory(), 
         ...
         change_carry_while_holding=ChangeCarryWhileHolding.TunableFactory(), 
         ...
         travel_group_claim_object=TravelGroupClaimObject.TunableFactory(), 
