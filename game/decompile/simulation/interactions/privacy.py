...
# Size of source mod 2**32: 47296 bytes
...
import enum, placement, routing, services, sims4.geometry, sims4.log, snippets, constraints
        ...
        if self.central_object is None:
            ...
            if area > self._MIN_ROOM_AREA_FOR_DISCOURAGEMENT:
                for poly in self.constraint.geometry.polygon:
                    self._privacy_constraints.append(PolygonFootprint(poly, routing_surface=routing_surface,
                      cost=(self.privacy_discouragement_cost),
