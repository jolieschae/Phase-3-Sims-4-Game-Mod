...
# Size of source mod 2**32: 43416 bytes
...
class ObjectCreationElement(XevtTriggeredElement, ObjectCreationMixin):
    ...
    def _build_outer_elements(self, sequence):
        ...
        def enter_carry(timeline):
            carry_element_helper = CarryElementHelper(interaction=(self.interaction), carry_target=(self.interaction.created_target),
              carry_track=(self.location.carry_track_override),
