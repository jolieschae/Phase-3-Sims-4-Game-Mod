...
# Size of source mod 2**32: 96479 bytes
...
class InteractionOutcomePartial(InteractionOutcome):
 ...
 L.1247         8  LOAD_FAST                'interaction'
 ...
 L.1266       188  LOAD_FAST                'valid_sim_ids'
              190  LOAD_METHOD              add
              192  LOAD_FAST                'sim'
              194  LOAD_ATTR                id
 ...
 L.1271       234  BUILD_LIST_0          0 
              236  STORE_FAST               'bullet_points'

 L.1272       238  SETUP_LOOP          298  'to 298'
              240  LOAD_FAST                'picked_sims'
              242  GET_ITER         
              244  FOR_ITER            296  'to 296'
              246  STORE_FAST               'sim'

 L.1273       248  LOAD_FAST                'self'
 ...
 L.1274       264  LOAD_FAST                'return_val'
          266_268  POP_JUMP_IF_TRUE    282  'to 282'

 L.1275       270  LOAD_FAST                'bullet_points'
 ...
 L.1277       282  LOAD_FAST                'valid_sim_ids'
              284  LOAD_METHOD              add
              286  LOAD_FAST                'sim'
              288  LOAD_ATTR                id
 ...
 L.1287       390  LOAD_GLOBAL              LocalizationHelperTuning
 ...
 L.1311       634  LOAD_FAST                'interaction'
...
Parse error at or near `COME_FROM' instruction at offset 474_0
        ...
        def _create_response(interaction, *, animations, setup_asm_override=DEFAULT, **kwargs):
            ...
            def generate_setup_asm(sim, actor_name):
                ...
                def setup_asm(asm):
                    ...
                    if result:
                        if interaction.set_carry_track_param:
