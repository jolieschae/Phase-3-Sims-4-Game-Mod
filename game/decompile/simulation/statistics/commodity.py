...
# Size of source mod 2**32: 111722 bytes
...
class CommodityState:
    __slots__ = ('_value', '_buff', '_buff_overrides', '_icon', '_icon_overrides',
                 ...
                 '_fill_color', '_fill_color_overrides', '_background_color', '_tooltip_icon_list',
                 '_tooltip_icon_list_overrides', 'loot_list_on_enter_always', 'loot_list_on_enter_increasing',
                 'loot_list_on_enter_decreasing', 'apply_loot_on_load', '_ui_container_animation_increasing',
