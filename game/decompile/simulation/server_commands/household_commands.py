...
# Size of source mod 2**32: 33872 bytes
...
def household_split(sourceHouseholdId, targetHouseholdId=0, cancelable=True, allow_sim_transfer=True, selected_sim_ids=[], destination_zone_id=0, callback_command_name=None, lock_preselected_sims=True):
...
def household_transfer_sims_live_mode(transfer_sims_data: str, _connection=None):
    ...
    if proto.target_household_id == 0:
        ...
        if source_household is not None:
