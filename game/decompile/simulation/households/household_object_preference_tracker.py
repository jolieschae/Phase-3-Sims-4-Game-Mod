...
# Size of source mod 2**32: 24300 bytes
    ...
    def safe_copy_restricted_objects_for_sim_ids(self, other_tracker, sim_ids, preference_tag, zone_id):
        ...
        for sim_id in sim_ids:
            ...
            if subroot_index is None:
                self_preference_data.get_restricted_sims(object_id) or self_preference_data.set_restriction(object_id, subroot_index, sim_id)
                continue
