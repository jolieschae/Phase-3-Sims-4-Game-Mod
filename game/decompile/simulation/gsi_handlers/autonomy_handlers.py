...
def archive_autonomy_data(sim, result, mode_name, gsi_data):
    ...
    if gsi_data is not None:
        ...
        archive_data['Mixers'] = [{'mixer_provider': 'mixer_provider', 'affordance': 'affordance_name', 'target': 'target_name', 
         'sub_weight': 'weight', 'sub_details': 'details'} for weight, mixer_provider, affordance_name, target_name, details in gsi_data[GSIDataKeys.MIXERS_KEY]]
