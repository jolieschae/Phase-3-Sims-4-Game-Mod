...
# Size of source mod 2**32: 74044 bytes
import itertools
    ...
    if sim_info is not None:
        ...
        for buff in buff_component:
            entry = {'sim_id':str(sim_id), 
             ...
             'display_type':str(buff.display_type), 
...
def archive_sim_motives():
    ...
    if sim_info_manager is None:
        ...
        return
    all_motives = [
     "'motive_fun'", "'motive_social'", "'motive_hygiene'", "'motive_hunger'", 
     "'motive_energy'", "'motive_bladder'"]
