...
# Size of source mod 2**32: 43856 bytes
...
class _PlacementStrategyLocation(_PlacementStrategy):
    ...
    def _try_place_object_internal(self, obj, target_obj, resolver, ignored_object_ids=None, **kwargs):
        ...
        if self.raytest:
            ...
            raytest_info = RaytestInfo(raytest_radius=(self.raytest.raytest_radius), raytest_start_offset=(self.raytest.raytest_start_height_offset),
              raytest_end_offset=(self.raytest.raytest_end_height_offset),
              raytest_start_point_override=start_point_override)
        restrictions = None
