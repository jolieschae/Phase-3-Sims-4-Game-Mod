...
# Size of source mod 2**32: 33091 bytes
import weakref
...
class BaseObject(ComponentContainer):
 ...
 L. 767         6  LOAD_FAST                'anim_overrides'
                8  LOAD_CONST               None
               10  COMPARE_OP               is
               12  POP_JUMP_IF_FALSE    18  'to 18'

 L. 768        14  LOAD_CONST               None
               16  RETURN_VALUE     
             18_0  COME_FROM            12  '12'

 L. 770        18  LOAD_DEREF               'actor_name'
               20  LOAD_CONST               None
 ...
 L. 772        32  LOAD_FAST                'anim_overrides'
 ...
 L. 773        44  LOAD_FAST                'anim_overrides'
               46  LOAD_ATTR                params
 ...
 L. 775        62  LOAD_FAST                'anim_overrides'
               64  RETURN_VALUE     
               -1  RETURN_LAST      
...
Parse error at or near `LOAD_DICTCOMP' instruction at offset 38
 ...
 L. 781         0  LOAD_FAST                'self'
                2  LOAD_ATTR                _anim_overrides_internal
                4  STORE_FAST               'anim_overrides'

 L. 782         6  LOAD_FAST                'anim_overrides'
                8  LOAD_CONST               None
               10  COMPARE_OP               is
               12  POP_JUMP_IF_FALSE    18  'to 18'

 L. 783        14  LOAD_CONST               None
               16  RETURN_VALUE     
             18_0  COME_FROM            12  '12'

 L. 785        18  LOAD_DEREF               'actor_name'
               20  LOAD_CONST               None
               22  COMPARE_OP               is-not
 ...
 L. 787        32  LOAD_CLOSURE             'actor_name'
 ...
 L. 790        58  LOAD_FAST                'anim_overrides'
               60  LOAD_ATTR                params
               62  RETURN_VALUE     
               -1  RETURN_LAST      
