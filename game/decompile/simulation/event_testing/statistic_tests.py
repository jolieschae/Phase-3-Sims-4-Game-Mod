...
# Size of source mod 2**32: 61165 bytes
        ...
        for affordance in obj.super_affordances(context):
            ...
            for aop in affordance.potential_interactions(obj, context):
                if check_suppression:
                    if obj.check_affordance_for_suppression((context.sim), aop, False, check_option=(SuppressionCheckOption.PROVIDED_AFFORDANCE_ONLY)):
                        continue
                if test_aops:
