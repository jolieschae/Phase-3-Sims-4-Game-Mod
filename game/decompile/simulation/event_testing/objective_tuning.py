...
# Size of source mod 2**32: 54830 bytes
...
class TunableObjectiveTestVariant(TunableVariant):
 ...
 'tooltip':None}), 
         ...
         location_test=world.world_tests.LocationTest.TunableFactory(location_tests={
 'is_outside': False, 
