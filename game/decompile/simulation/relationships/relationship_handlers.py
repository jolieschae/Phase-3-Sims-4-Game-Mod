...
def generate_relationship_view_data(sim_id: int=None):
    ...
    for rel in relationship_service.get_all_sim_relationships(sim_id):
        ...
        entry = {'relationship_sim_id':str(target_sim_id),  'depth':rel.get_relationship_depth(sim_id), 
        ...
        entry['compatibility'] = [
         {'compatibility_score':str(rel.get_compatibility_score()), 
          'compatibility_level':str(rel.get_compatibility_level())}]

    for rel in relationship_service.get_all_sim_object_relationships(sim_id):
        obj_def = rel.find_member_obj_b()
        entry = {'relationship_sim_id':str(rel.sim_id_b),  'depth':rel.get_relationship_depth(sim_id), 
         'sim_id':str(sim_info.sim_id)}
        target_name = None
