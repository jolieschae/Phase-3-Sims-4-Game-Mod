...
import clock, game_services, indexed_manager, native.animation, paths, server.account, services, sims.sim_spawner, sims4.core_services, sims4.geometry, sims4.gsi.http_service, sims4.log, sims4.perf_log, sims4.zone_utils, telemetry_helper, sims4.resources
