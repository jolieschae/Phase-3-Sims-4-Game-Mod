...
# Size of source mod 2**32: 48732 bytes
...
class DaycareService(Service):
    ...
    def get_number_of_eligible_daycare_sims(self, household):
        return sum((1 for sim_info in self._potential_daycare_sims(household) if sim_info.is_toddler_or_younger if not sim_info.is_pet))
