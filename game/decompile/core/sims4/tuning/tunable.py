...
class TunableMapping(TunableList):
    ...
    def _process_dict_value--- This code section failed: ---

 L.1625         0  LOAD_FAST                'value'
                2  LOAD_CONST               None
                4  COMPARE_OP               is-not
                6  POP_JUMP_IF_FALSE    98  'to 98'

 L.1626         8  LOAD_GLOBAL              len
               10  LOAD_FAST                'value'
 ...
 L.1627        20  LOAD_GLOBAL              TunableMapping
               22  LOAD_ATTR                DEFAULT_MAPPING
               24  RETURN_VALUE     
             26_0  COME_FROM            18  '18'

 L.1629        26  LOAD_FAST                'self'
               28  LOAD_ATTR                _key_name
               30  STORE_DEREF              'key_name'

 L.1630        32  LOAD_FAST                'self'
               34  LOAD_ATTR                _value_name
               36  STORE_DEREF              'value_name'

 L.1631        38  LOAD_CONST               False
               40  POP_JUMP_IF_FALSE    70  'to 70'
               42  LOAD_FAST                'self'
               44  LOAD_ATTR                allow_none
               46  POP_JUMP_IF_FALSE    70  'to 70'

 L.1632        48  LOAD_CLOSURE             'key_name'
               50  LOAD_CLOSURE             'value_name'
               52  BUILD_TUPLE_2         2 
               54  LOAD_DICTCOMP            '<code_object <dictcomp>>'
               56  LOAD_STR                 'TunableMapping._process_dict_value.<locals>.<dictcomp>'
               58  MAKE_FUNCTION_8          'closure'
               60  LOAD_FAST                'value'
               62  GET_ITER         
               64  CALL_FUNCTION_1       1  '1 positional argument'
               66  STORE_FAST               'dict_items'
               68  JUMP_FORWARD         90  'to 90'
             70_0  COME_FROM            46  '46'
             70_1  COME_FROM            40  '40'

 L.1634        70  LOAD_CLOSURE             'key_name'
               72  LOAD_CLOSURE             'value_name'
               74  BUILD_TUPLE_2         2 
               76  LOAD_DICTCOMP            '<code_object <dictcomp>>'
               78  LOAD_STR                 'TunableMapping._process_dict_value.<locals>.<dictcomp>'
               80  MAKE_FUNCTION_8          'closure'
               82  LOAD_FAST                'value'
               84  GET_ITER         
               86  CALL_FUNCTION_1       1  '1 positional argument'
               88  STORE_FAST               'dict_items'
             90_0  COME_FROM            68  '68'

 L.1664        90  LOAD_GLOBAL              frozendict
               92  LOAD_FAST                'dict_items'
               94  CALL_FUNCTION_1       1  '1 positional argument'
               96  STORE_FAST               'value'
             98_0  COME_FROM             6  '6'

 L.1666        98  LOAD_FAST                'value'
              100  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `LOAD_DICTCOMP' instruction at offset 54
