...
class ParserBase:
                    ...
                    if c in self._decl_otherchars:
                        ...
                        if c == '[':
                            if decltype == 'doctype':
                                ...
                                if decltype in frozenset({'attlist', 'element', 'link', 'linktype'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            ...
            if sectName in frozenset({'include', 'ignore', 'temp', 'rcdata', 'cdata'}):
                match = _markedsectionclose.search(rawdata, i + 3)
            else:
                if sectName in frozenset({'else', 'endif', 'if'}):
    ...
    def _parse_doctype_subset(self, i, declstartpos):
        ...
        while j < n:
            ...
            if c == '<':
                ...
                if j == -1:
                    return -1
                    if name not in frozenset({'attlist', 'entity', 'notation', 'element'}):
