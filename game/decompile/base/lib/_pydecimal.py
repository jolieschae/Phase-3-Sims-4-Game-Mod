...
__all__ = [
 ...
 "'ExtendedContext'", 
 "'DecimalException'", "'Clamped'", "'InvalidOperation'", 
 "'DivisionByZero'", 
 "'Inexact'", "'Rounded'", "'Subnormal'", "'Overflow'", 
 "'Underflow'", 
 "'FloatOperation'", 
 "'DivisionImpossible'", "'InvalidContext'", 
 "'ConversionSyntax'", "'DivisionUndefined'", 
 "'ROUND_DOWN'", "'ROUND_HALF_UP'", 
 "'ROUND_HALF_EVEN'", "'ROUND_CEILING'", 
 "'ROUND_FLOOR'", "'ROUND_UP'", 
 "'ROUND_HALF_DOWN'", "'ROUND_05UP'", 
 "'setcontext'", "'getcontext'", "'localcontext'", 
 "'MAX_PREC'", 
 "'MAX_EMAX'", "'MIN_EMIN'", "'MIN_ETINY'", 
 "'HAVE_THREADS'"]
__xname__ = __name__
__name__ = 'decimal'
__version__ = '1.70'
...
_signals = [
 ...
 'Underflow', 
 'InvalidOperation', 'Subnormal', 'FloatOperation']
