...
# Embedded file name: /Users/sims4builder/build/Beta/_deploy/Client/MacRelease/The Sims 4.app/Contents/Python/Generated/protocolbuffers/Audio_pb2.py
...
_SOUNDSTART = descriptor.Descriptor(name='SoundStart',
 ...
 descriptor.FieldDescriptor(name='play_on_active_sim_only',
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='sound_name',
   full_name='EA.Sims4.Network.SoundStart.sound_name',
   index=6,
   number=7,
   type=9,
   cpp_type=9,
