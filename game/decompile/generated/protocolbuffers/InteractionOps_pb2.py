...
# Embedded file name: /Users/sims4builder/build/Beta/_deploy/Client/MacRelease/The Sims 4.app/Contents/Python/Generated/protocolbuffers/InteractionOps_pb2.py
# Compiled at: 2023-04-20 22:46:30
# Size of source mod 2**32: 39425 bytes
...
_PIEMENUITEM = descriptor.Descriptor(name='PieMenuItem',
 ...
 descriptor.FieldDescriptor(name='icon_infos',
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='display_notification',
   full_name='EA.Sims4.Network.PieMenuItem.display_notification',
   index=16,
   number=18,
   type=8,
   cpp_type=7,
 ...
 descriptor.FieldDescriptor(name='affordance_id',
   full_name='EA.Sims4.Network.PieMenuItem.affordance_id',
   index=17,
   number=19,
   type=4,
   cpp_type=4,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='phone_notification_control_override',
   full_name='EA.Sims4.Network.PieMenuItem.phone_notification_control_override',
   index=18,
   number=20,
   type=8,
   cpp_type=7,
...
_SIMTRANSFERREQUEST = descriptor.Descriptor(name='SimTransferRequest',
 ...
 descriptor.FieldDescriptor(name='active_sim_id',
  ...
  serialized_end=2269)
_PHONENOTIFICATIONUPDATE = descriptor.Descriptor(name='PhoneNotificationUpdate',
  full_name='EA.Sims4.Network.PhoneNotificationUpdate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='interaction_ids',
   full_name='EA.Sims4.Network.PhoneNotificationUpdate.interaction_ids',
   index=0,
   number=1,
   type=4,
   cpp_type=4,
   ...
   options=(descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\x10\x01'))),
 descriptor.FieldDescriptor(name='sim_id',
   full_name='EA.Sims4.Network.PhoneNotificationUpdate.sim_id',
   index=1,
   number=2,
   type=4,
   cpp_type=4,
