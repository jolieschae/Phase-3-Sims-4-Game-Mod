...
# Embedded file name: /Users/sims4builder/build/Beta/_deploy/Client/MacRelease/The Sims 4.app/Contents/Python/Generated/protocolbuffers/WeatherSeasons_pb2.py
# Compiled at: 2023-04-20 22:46:31
# Size of source mod 2**32: 27495 bytes
...
_SEASONWEATHERINTERPOLATIONMESSAGE_SEASONWEATHERINTERPOLATEDTYPE = descriptor.EnumDescriptor(name='SeasonWeatherInterpolatedType',
 ...
 descriptor.EnumValueDescriptor(name='SKYBOX_INDUSTRIAL',
  ...
  serialized_end=1038)
_MOONPHASEUPDATE_MOONPHASE = descriptor.EnumDescriptor(name='MoonPhase',
  full_name='EA.Sims4.Network.MoonPhaseUpdate.MoonPhase',
  filename=None,
  file=DESCRIPTOR,
  values=[
 descriptor.EnumValueDescriptor(name='DEFAULT_NO_MOON',
   index=0,
   number=(-1),
   options=None,
   type=None),
 ...
 descriptor.EnumValueDescriptor(name='WANING_CRESCENT',
  ...
  serialized_end=1955)
_MOONFORECASTUPDATE_MOONPHASE = descriptor.EnumDescriptor(name='MoonPhase',
  full_name='EA.Sims4.Network.MoonForecastUpdate.MoonPhase',
  filename=None,
  file=DESCRIPTOR,
  values=[
 descriptor.EnumValueDescriptor(name='DEFAULT_NO_MOON',
...
_UIWEATHERFORECASTUPDATE = descriptor.Descriptor(name='UiWeatherForecastUpdate',
 ...
 descriptor.FieldDescriptor(name='forecast_instance_ids',
  ...
  serialized_end=1629)
_MOONPHASEUPDATE = descriptor.Descriptor(name='MoonPhaseUpdate',
  full_name='EA.Sims4.Network.MoonPhaseUpdate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='current_moon_phase',
   full_name='EA.Sims4.Network.MoonPhaseUpdate.current_moon_phase',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
   ...
   extension_scope=None,
   options=None),
 descriptor.FieldDescriptor(name='skip_environment_changes',
   full_name='EA.Sims4.Network.MoonPhaseUpdate.skip_environment_changes',
   index=1,
   number=2,
   type=8,
   cpp_type=7,
  ...
  nested_types=[],
  enum_types=[
 _MOONPHASEUPDATE_MOONPHASE],
  options=None,
  is_extendable=False,
  extension_ranges=[],
  serialized_start=1632,
  serialized_end=1955)
_UILUNAREFFECTTOOLTIPUPDATE = descriptor.Descriptor(name='UiLunarEffectTooltipUpdate',
  full_name='EA.Sims4.Network.UiLunarEffectTooltipUpdate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='current_moon_phase',
   full_name='EA.Sims4.Network.UiLunarEffectTooltipUpdate.current_moon_phase',
   index=0,
   number=1,
   type=13,
   cpp_type=3,
 ...
 descriptor.FieldDescriptor(name='tooltip_text',
   full_name='EA.Sims4.Network.UiLunarEffectTooltipUpdate.tooltip_text',
   index=1,
   number=2,
   type=11,
   cpp_type=10,
  ...
  serialized_end=2070)
_MOONFORECASTUPDATE = descriptor.Descriptor(name='MoonForecastUpdate',
  full_name='EA.Sims4.Network.MoonForecastUpdate',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
 descriptor.FieldDescriptor(name='forecast_moon_phases',
   full_name='EA.Sims4.Network.MoonForecastUpdate.forecast_moon_phases',
   index=0,
   number=1,
   type=14,
   cpp_type=8,
...
_MOONPHASEUPDATE.fields_by_name['current_moon_phase'].enum_type = _MOONPHASEUPDATE_MOONPHASE
_MOONPHASEUPDATE_MOONPHASE.containing_type = _MOONPHASEUPDATE
_UILUNAREFFECTTOOLTIPUPDATE.fields_by_name['tooltip_text'].message_type = Localization_pb2._LOCALIZEDSTRING
_MOONFORECASTUPDATE.fields_by_name['forecast_moon_phases'].enum_type = _MOONFORECASTUPDATE_MOONPHASE
_MOONFORECASTUPDATE_MOONPHASE.containing_type = _MOONFORECASTUPDATE
...
DESCRIPTOR.message_types_by_name['MoonPhaseUpdate'] = _MOONPHASEUPDATE
DESCRIPTOR.message_types_by_name['UiLunarEffectTooltipUpdate'] = _UILUNAREFFECTTOOLTIPUPDATE
DESCRIPTOR.message_types_by_name['MoonForecastUpdate'] = _MOONFORECASTUPDATE
...
class MoonPhaseUpdate(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
    DESCRIPTOR = _MOONPHASEUPDATE


class UiLunarEffectTooltipUpdate(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
    DESCRIPTOR = _UILUNAREFFECTTOOLTIPUPDATE


class MoonForecastUpdate(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
    DESCRIPTOR = _MOONFORECASTUPDATE